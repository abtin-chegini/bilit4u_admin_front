  ...
  return (
    <>
      <div>
          ...
          >
            {isPending ? (
              ...
              <>
                ...
                <div className="flex items-center gap-x-6">
                  <div className="text-black text-base font-bold direction-rtl">
                    {data?.CoName}
                  </div>
                  <div className="p-2">
                    <Image
            ...
            <div className="flex items-center py-3.5 z-20 w-full">
              <div className="flex flex-col px-5 xl:px-9 gap-y-4 w-1/3">
                ...
                {isPending ? (
                  ...
                  <div className="flex direction-rtl items-center gap-x-2 min-h-[30px]">
                    {isDepartingSoon && (
                      <>
                ...
                {isPending ? (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm xl:text-base text-[#0D5990] font-IranYekanBold direction-rtl">
                      {numberConvertor(
                    ...
                    <div className="w-[40%] text-center">
                      <div className="relative w-full h-[90px] flex flex-col justify-center">
                        ...
                        <div className="relative w-full h-[40px] mb-2">
                          ...
                          <div dir="rtl" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#E8F2FC] text-[#0D5990] px-2 py-1 rounded-full font-IranYekanBold text-[10px] border border-[#CCD6E1] min-w-[80px] text-center">
                            {formattedDuration}
                          </div>
                        </div>
        ...
        <div className="shadow-2 rounded-xl relative hidden sm:block lg:hidden font-IranYekanRegular">
          ...
          {isPending ? (
            ...
            <div className="flex px-9 items-center justify-between bg-white border-b border-secondary rounded-t-xl font-IranYekanRegular">
              ...
              <div className="flex items-center gap-x-6">
                <div className="text-black text-base font-IranYekanBold direction-rtl">
                  {data?.CoName}
                </div>
                <div className="p-2">
                  <Image
          ...
          <div className="flex flex-col items-center relative">
            ...
            <div className="flex flex-col gap-y-2.5 p-4 w-full">
                  ...
                  <div className="w-1/2 text-center">
                    <div className="relative w-full h-[120px] flex flex-col justify-center">
                      ...
                      <div className="relative w-full h-[35px] mb-2">
                        ...
                        {/* Only duration inside the curve */}
                        <div dir="rtl" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#E8F2FC] text-[#0D5990] px-3 py-4 rounded-full font-IranYekanBold text-[12px] border border-[#CCD6E1] min-w-[100px] text-center">
                          {formattedDuration}
                        </div>
                      </div>
              ...
              <div className="flex direction-rtl items-center gap-x-2 justify-end min-h-[24px]">
        ...
        <div className="shadow-lg rounded-xl border border-[#CCD6E1] flex flex-col gap-y-2.5 my-4 sm:hidden">
          {/* Mobile header */}
          {isPending ? (
            ...
            <div className="flex items-center w-full mb-2">
              ...
              <div className="flex flex-col items-center w-1/2">
                ...
                <div className="flex items-center h-full w-full relative">
                  ...
                  {!isPending && (
                    <div dir="rtl" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#E8F2FC] text-[#0D5990] px-2 py-2 rounded-full text-[10px] border border-[#CCD6E1] min-w-[120px] text-center font-IranYekanBold">
                      {formattedDuration}
                    </div>
                  )}
                </div>
          ...
          <div className="flex direction-rtl items-center gap-x-2 justify-center px-4 min-h-[20px]">
            {!isPending && isDepartingSoon && (
              <>
                <ClockIcon className="text-red-500 px-0.5" />
