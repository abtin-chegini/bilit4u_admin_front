      ...
      <Card className="p-6 bg-white shadow-sm">
        <div className="space-y-6">
          <div className="text-right space-y-4">
            ...
            >
              برای جستجو مسافر مورد نظر خود، مشخصات شناسایی ایشان را وارد نمایید
            </motion.p>
          </div>
          ...
          >
            ...
            >
              <Input
                type="text"
                placeholder="جستجو در نام، نام خانوادگی، کد ملی، شماره تلفن..."
                value={searchTerm}
            ...
            >
              <Select value={genderFilter} onValueChange={setGenderFilter}>
                <SelectTrigger className="text-right border-[#ccd6e1] focus:border-[#0d5990] [&>span]:text-right [&>span]:w-full font-IranYekanRegular">
                  <SelectValue placeholder="فیلتر جنسیت" />
                </SelectTrigger>
                <SelectContent className="text-right font-IranYekanRegular" dir="rtl">
                  <SelectItem value="all" className="text-right">همه</SelectItem>
                  <SelectItem value="مرد" className="text-right">مرد</SelectItem>
                  <SelectItem value="زن" className="text-right">زن</SelectItem>
                </SelectContent>
              </Select>
            </motion.div>
