      ...
      <Card className="p-6 bg-white shadow-sm">
        <div className="space-y-6">
          <div className="text-right space-y-4">
            ...
            >
              برای جستجو کاربر مورد نظر خود، مشخصات شناسایی ایشان را وارد نمایید
            </motion.p>
          </div>
          ...
          >
            ...
            >
              <Input
                type="text"
                placeholder="جستجو در نام، ایمیل، شماره تماس، کد پرسنلی..."
                value={searchTerm}
            ...
            >
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                ...
                <SelectContent className="text-right font-IranYekanRegular" dir="rtl">
                  ...
                  <SelectItem value="inactive" className="text-right">غیرفعال</SelectItem>
                </SelectContent>
              </Select>
            </motion.div>
