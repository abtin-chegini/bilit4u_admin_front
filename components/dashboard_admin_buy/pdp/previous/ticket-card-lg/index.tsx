...
const TicketCardLg: React.FC<TicketCardLgProps> = ({ ticketDetails, orderData, isDimmed = false }) => {
  ...
  // Debug logging for TicketCardLg component
  React.useEffect(() => {
    console.log('🎫 TicketCardLg - Component initialized with data:', {
      hasTicketDetails: !!ticketDetails,
      ticketDetailsKeys: ticketDetails ? Object.keys(ticketDetails) : null,
      ticketDetailsData: ticketDetails,
      validation: {
        hasServiceNo: !!ticketDetails?.ServiceNo,
        hasCoName: !!ticketDetails?.CoName,
        hasDepartDate: !!ticketDetails?.DepartDate,
        hasDepartTime: !!ticketDetails?.DepartTime,
        hasFullPrice: !!ticketDetails?.FullPrice,
        hasSrcCityName: !!ticketDetails?.SrcCityName,
        hasDesCityName: !!ticketDetails?.DesCityName,
        hasLogoUrl: !!ticketDetails?.LogoUrl,
        hasBusType: !!ticketDetails?.BusType,
        hasSrcCityCode: !!ticketDetails?.SrcCityCode,
  ...
  // Debug city codes
  console.log('🗺️ TicketCardLg - City codes for route info:', {
    srcCityCode,
    desCityCode,
    hasSrcCityCode: !!srcCityCode,
    hasDesCityCode: !!desCityCode,
    ticketDetailsSrcCityCode: ticketDetails?.SrcCityCode,
    ticketDetailsDesCityCode: ticketDetails?.DesCityCode
  });
  ...
  // Debug route info
  console.log('🛣️ TicketCardLg - Route info result:', {
    routeInfo,
    hasDuration: !!routeInfo?.duration,
    hasDistance: !!routeInfo?.formattedDistance,
  ...
  console.log('📅 TicketCardLg - Calculated values:', {
    formattedDuration,
    arrivalTime,
    arrivalDate,
    departureDate,
  ...
  React.useEffect(() => {
    console.log('🎫 TicketCardLg - Ready to render with real ticketDetails from API');
  }, []);
        ...
        >
          ...
          <div className="relative w-[66.5%]  h-full">
            ...
            <div className="flex flex-col justify-between w-full h-full">
              ...
              {/* Amenities section - positioned at bottom right of main card */}
              <div className="mx-8 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  {ticketDetails?.IsMonitor && (
                    <div className="flex items-center gap-1">
                      <svg width="16" height="16" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.2129 0.166992H2.21293C1.29626 0.166992 0.546265 0.916992 0.546265 1.83366V11.8337C0.546265 12.7503 1.29626 13.5003 2.21293 13.5003H8.04626V15.167H6.3796V16.8337H13.0463V15.167H11.3796V13.5003H17.2129C18.1296 13.5003 18.8796 12.7503 18.8796 11.8337V1.83366C18.8796 0.916992 18.1296 0.166992 17.2129 0.166992ZM17.2129 11.8337H2.21293V1.83366H17.2129V11.8337Z" fill="#0D5990" />
                      </svg>
                      <span className="text-[12px] text-[#0D5990] font-IranYekanRegular">مانیتور</span>
                    </div>
                  )}
                  ...
                  {ticketDetails?.IsBed && (
                    <div className="flex items-center gap-1">
                      <svg width="16" height="16" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.87956 10.8333C5.52956 10.8333 6.17122 10.5833 6.66289 10.0833C7.62956 9.09167 7.61289 7.51667 6.62956 6.55C6.13789 6.075 5.50456 5.83333 4.87956 5.83333C4.22956 5.83333 3.58789 6.08333 3.09622 6.58333C2.12956 7.575 2.14622 9.15 3.12956 10.1167C3.62122 10.5917 4.25456 10.8333 4.87956 10.8333ZM4.28789 7.75C4.44622 7.59167 4.65456 7.5 4.87956 7.5C5.09622 7.5 5.30456 7.58333 5.46289 7.73333C5.79622 8.05833 5.79622 8.575 5.47956 8.90833C5.31289 9.075 5.10456 9.16667 4.87956 9.16667C4.66289 9.16667 4.45456 9.08333 4.29622 8.93333C3.96289 8.6 3.96289 8.08333 4.28789 7.75ZM15.7129 5.83333H8.21289V10.8333H19.0462V9.16667C19.0462 7.325 17.5546 5.83333 15.7129 5.83333ZM9.87956 9.16667V7.5H15.7129C16.6296 7.5 17.3796 8.25 17.3796 9.16667H9.87956ZM2.37956 13.3333H7.37956H14.0462H19.0462V11.6667H2.37956V13.3333Z" fill="#0D5990" />
                      </svg>
                      <span className="text-[12px] text-[#0D5990] font-IranYekanRegular">تختخوابشو</span>
                    </div>
                  )}
                  ...
                  {ticketDetails?.IsVIP && (
                    <div className="flex items-center gap-1">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26" fill="#0D5990" />
                      </svg>
                      <span className="text-[12px] text-[#0D5990] font-IranYekanRegular">VIP</span>
                    </div>
                  )}
                  ...
                  {ticketDetails?.IsSofa && (
                    <div className="flex items-center gap-1">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 9V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v3" fill="#0D5990" />
                        <path d="M2 11v5a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z" fill="#0D5990" />
                        <path d="M4 18v2" fill="#0D5990" />
                        <path d="M20 18v2" fill="#0D5990" />
                        <path d="M12 4v4" fill="#0D5990" />
                      </svg>
                      <span className="text-[12px] text-[#0D5990] font-IranYekanRegular">مبلی</span>
                    </div>
                  )}
                  ...
                  {ticketDetails?.IsMono && (
                    <div className="flex items-center gap-1">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="8" y="6" width="8" height="12" rx="1" fill="#0D5990" />
                        <path d="m8 18-2 2" fill="#0D5990" />
                        <path d="m16 18 2 2" fill="#0D5990" />
                        <path d="M8 14h8" fill="#0D5990" />
                        <path d="M8 10h8" fill="#0D5990" />
                      </svg>
                      <span className="text-[12px] text-[#0D5990] font-IranYekanRegular">تک صندلی</span>
                    </div>
                  )}
                  ...
                  {ticketDetails?.IsAirConditionType && (
                    <div className="flex items-center gap-1">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="12" cy="12" r="3" fill="#0D5990" />
                        <path d="M12 1v6m0 6v6" fill="#0D5990" />
                        <path d="M22.5 12h-6m-9 0h-6" fill="#0D5990" />
                        <path d="M19.07 4.93l-4.24 4.24m0 5.66l4.24 4.24" fill="#0D5990" />
                        <path d="M4.93 4.93l4.24 4.24m0 5.66l-4.24 4.24" fill="#0D5990" />
                        <path d="M18 6l-3 3m0 6l3 3" fill="#0D5990" />
                        <path d="M6 6l3 3m0 6l-3 3" fill="#0D5990" />
                      </svg>
                      <span className="text-[12px] text-[#0D5990] font-IranYekanRegular">تهویه</span>
                    </div>
                  )}
                </div>
              </div>
