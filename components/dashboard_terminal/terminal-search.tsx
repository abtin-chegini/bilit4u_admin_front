...
export function TerminalSearch({ searchTerm, setSearchTerm, onClearFilters }: TerminalSearchProps) {
			...
			<Card className="p-6 bg-white shadow-sm">
				<div className="space-y-6">
					<div className="text-right space-y-4">
						...
						>
							برای یافتن ترمینال مورد نظر، نام یا شناسه ترمینال را وارد نمایید
						</motion.p>
					</div>
					...
					>
						...
						>
							<Input
								type="text"
								placeholder="جستجو در نام، توضیحات یا شناسه ترمینال..."
								value={searchTerm}
						...
						>
							<Button
								...
								className={`w-full border-[#ccd6e1] transition-all duration-200 font-IranYekanRegular ${
									hasActiveFilters
